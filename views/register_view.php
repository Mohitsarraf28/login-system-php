...
<body>
    <div class="h-screen flex justify-center items-center">
        ...
        <form method="post" action="../public/register.php" class="flex flex-col gap-5 shadow-2xl shadow-slate-500 rounded-3xl p-5">
            <h1 class="text-2xl font-bold text-center">Register</h1>
            <input type="text" name="username" placeholder="Username" required class="rounded-xl shadow-2xl py-2 px-4 bg-slate-200">
            ...
            <button type="submit" name="register" class="w-full bg-green-400 hover:bg-green-700 py-2 px-4 rounded-2xl text-white">Register</button>
        </form>
    </div>
</body>
</html>
